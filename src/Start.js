      ...
      <div className="page-wrapper">
        <div className="start-box">
          <h2 className="start-title">
            <b>Campus Discovery System</b>
          </h2>
          <p>The best place to find events around you</p>
          <br />
          <Button className="start-button" clickHandler={this.redirectToLogin}>
            Login
          </Button>
          <Button className="start-button" clickHandler={this.redirectToSignup}>
            Signup
          </Button>
        </div>
      </div>
