...
mapboxgl.accessToken =
  "pk.eyJ1IjoibmJoYWNoYXdhdDMiLCJhIjoiY2xhdnAzN3hxMDR6YzN1cnYwYXBpcDc1aiJ9.MvLxt9auJ4nfXMV_Zmbx1A";
...
export default class EditMap extends React.PureComponent {
  ...
  render() {
    return (
      <>
        <div className="sidebar">Click on desired event location</div>
