    ...
    return (
      <div className="filters-wrapper">
        <div className="filters-box">
          ...
          <form style={{ width: "100%" }}>
            ...
            <div className="input__group">
              ...
              <select
                id="f_access"
                name="access"
                value={this.state.filters.access}
                onChange={this.handleInput}
              >
                <option value=""></option>
          ...
          <Button
            className="filters_submit-btn"
            clickHandler={this.handleSubmit}
          >
            Submit
          </Button>
          <Button className="filters_reset-btn" clickHandler={this.handleReset}>
            Reset
          </Button>
